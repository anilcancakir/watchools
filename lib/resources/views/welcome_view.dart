...
class WelcomeView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: wColor(context, 'gray', shade: 50, darkColorName: 'gray', darkShade: 900),
      body: Center(
              ...
              children: [
                ...
                const WDiv(
                  className: '''
                                        ...
                                        animate-bounce
                                    ''',
                  child: WIcon(Icons.auto_awesome, className: 'text-white text-4xl'),
                ),
                ...
                const WText('Built with Magic Framework', className: 'text-base text-gray-500 dark:text-gray-400'),
                ...
                WDiv(
                  ...
                  children: [
                    const WText('Made with', className: 'text-xs text-gray-400 dark:text-gray-500'),
                    const WDiv(
                      className: 'animate-pulse',
                      child: WText('❤️', className: 'text-xs text-red-500'),
                    ),
                    const WText('by', className: 'text-xs text-gray-400 dark:text-gray-500'),
                    WAnchor(
          ...
          children: [
            WDiv(
              className: '''
                            ...
                            ''',
              child: WIcon(icon, className: 'text-lg text-primary dark:text-primary-400'),
            ),
            WText(
              title,
              className: '''
        ...
        WAnchor(
          ...
          child: const WDiv(
            ...
            children: [
              ...
              WIcon(Icons.arrow_forward_outlined, className: 'text-sm text-primary dark:text-primary-400'),
            ],
          ),
        ),
      ],
